"""task2020_24577 URL Configuration
...
admin.site.site_header = "task2020"
admin.site.site_title = "task2020 Admin Portal"
admin.site.index_title = "task2020 Admin"

# swagger
api_info = openapi.Info(
    title="task2020 API",
    default_version="v1",
    description="API documentation for task2020 App",
)
